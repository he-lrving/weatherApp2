package com.example.he.weather_app2;
...
import com.example.he.weather_app2.MapActivity;
...
import com.example.he.weather_app2.gson.Weather;
import com.example.he.weather_app2.gson.Weather2;
import com.example.he.weather_app2.gson.Weather3;
import com.example.he.weather_app2.gson.Weather4;
import com.example.he.weather_app2.service.AutoUpdateService;
import com.example.he.weather_app2.util.HttpUtil;
import com.example.he.weather_app2.util.Utility;
...
public class WeatherActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wind_irText=(TextView)findViewById(R.id.wind_dir);
        wind_scText=(TextView)findViewById(R.id.wind_sc);
    ...
    private void showWeatherInfo(Weather weather){
        if (weather!=null&&"ok".equals(weather.status)){
            ...
            wind_dir=weather.now.wind_dir+"/";
            wind_sc=weather.now.wind_sc+"级";
            ...
            presText.setText(pres+"mb");
            titleCity.setText(cityName);
            titleUpdateTime.setText(updateTime);
            degreeText.setText(degree);
            weatherInfoText.setText(weatherInfo);
            wind_irText.setText(wind_dir);
            wind_scText.setText(wind_sc);
